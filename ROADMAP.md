...
- [ ] derive and implement analytic RBF/Gaussian expressions;
- [ ] test against high-accuracy deterministic quadrature;
- [ ] reject unsupported kernel/measure combinations explicitly.
